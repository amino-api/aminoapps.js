...
async function run(userId, chatId, allowRejoin, cb, deviceId) {
    return new Promise((resolve) => {
        ...
        const ifRejoin = allowRejoin ? 1 : 0;
        
        fetch(`${client.options.api}/g/s/chat/thread/${chatId}/member/${userId}?allowRejoin=${ifRejoin}`, {
            method: "DELETE",
            headers: headersV1,
